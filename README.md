...
- **Tipografía (v1.3, licencia OFL):** Anybody en su eje ancho (wdth 125, display, peso 500, interletrado −0.02 em), Fraunces con eje óptico (texto; SOFT 0, WONK 0; cursiva reservada a nombres botánicos) y Geist Mono (datos y etiquetas, caja alta, +0.14 em). Archivos auto-alojados en `app/fonts/` (woff2, subconjunto latino) con `next/font/local`; sin peticiones externas. Las familias anteriores (Archivo, Newsreader, JetBrains Mono) siguen disponibles en Google Fonts si LAND decide volver.
